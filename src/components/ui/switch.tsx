...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-6 w-[46px] shrink-0 cursor-pointer items-center rounded-full relative",
  ...
  >
    ...
    <span
      className={cn(
        ...
        "data-[state=unchecked]:left-[7.5px]",
        "data-[state=checked]:left-[calc(100%-16.5px)]"
      )}
