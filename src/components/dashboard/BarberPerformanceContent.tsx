  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card><CardContent className="pt-6"><div className="flex items-center gap-2"><Users className="h-5 w-5 text-primary" /><span className="text-sm text-muted-foreground">Barbeiros Ativos</span></div><p className="text-3xl font-bold mt-2">{summary.totalBarbers}</p></CardContent></Card>
