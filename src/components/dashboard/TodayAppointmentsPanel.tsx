    ...
    <div className="bg-card border border-[hsl(var(--border))] rounded-[14px] overflow-hidden flex-1">
      ...
      {appointments.length === 0 ? (
        <div className="px-4 py-8 text-center">
          <p className="text-sm font-semibold text-foreground">Nenhum agendamento para hoje</p>
          <p className="mt-1 text-xs text-muted-foreground">Os novos horários aparecerão aqui.</p>
        </div>
      ) : (
        <div>
