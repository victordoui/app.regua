...
export const DEFAULT_PUBLIC_PLANS: PlanConfig[] = [
  { id: 'trial', plan_type: 'trial', display_name: 'Teste gratuito', price_monthly: 0, price_yearly: null, max_barbers: 1, max_appointments_month: 50, features: {}, is_active: true, sort_order: 0, trial_days: 7, created_at: '', updated_at: '' },
