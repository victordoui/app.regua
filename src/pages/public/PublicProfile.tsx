...
import { User, Phone, Mail, Calendar, MapPin, Save, Lock } from 'lucide-react';
          ...
          <CardContent>
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div>
                ...
                <Input id="cpf" value={formData.cpf} onChange={(e) => setFormData(prev => ({ ...prev, cpf: e.target.value }))} placeholder="000.000.000-00" />
              </div>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input id="cep" value={formData.cep} onChange={(e) => setFormData(prev => ({ ...prev, cep: e.target.value }))} placeholder="00000-000" />
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="state" value={formData.state} onChange={(e) => setFormData(prev => ({ ...prev, state: e.target.value }))} />
                  </div>
                </div>
                <Button type="submit" className="w-full" disabled={loading}>
                  <Save className="h-4 w-4 mr-2" />
