                      ...
                      <>
                        ...
                        <div className="flex flex-wrap gap-3">
                          <div className="w-full rounded-xl border border-border bg-background p-4">
                            ...
                            <div className="mt-3 flex max-w-xl overflow-hidden rounded-lg border border-border bg-muted text-foreground shadow-sm">
                              <img src="/pwa-icon-192.png" alt="VIZZU" className="h-20 w-20 object-cover" />
                              <div className="min-w-0 p-3"><p className="truncate text-sm font-bold">VIZZU — Gestão inteligente de agendamentos</p><p className="truncate text-xs text-muted-foreground">Plataforma SaaS de gestão e agendamentos para profissionais de serviços.</p><p className="mt-1 text-xs text-muted-foreground">vizzuapp.netlify.app</p></div>
                            </div>
                          ...
                          <div className="w-full rounded-xl border border-primary/30 bg-primary/5 p-4">
                            ...
                            <div className="mt-3 flex max-w-xl overflow-hidden rounded-lg border border-border bg-muted text-foreground shadow-sm">
                              ...
                              <div className="min-w-0 p-3"><p className="truncate text-sm font-bold">{formData.company_name || "Sua empresa"} — Agendamento online</p><p className="truncate text-xs text-muted-foreground">{formData.slogan || "Agende seu horário online."}</p><p className="mt-1 text-xs text-muted-foreground">vizzuapp.netlify.app</p></div>
                            </div>
