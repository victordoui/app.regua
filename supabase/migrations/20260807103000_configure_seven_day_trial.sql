-- Product decision: the public evaluation period is seven days.
-- Existing subscriptions keep their original end date; this applies only to new trials.
update public.platform_plan_config
set display_name = 'Teste gratuito',
    trial_days = 7,
    updated_at = now()
